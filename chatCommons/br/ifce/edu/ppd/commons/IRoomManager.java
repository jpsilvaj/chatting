...
public interface IRoomManager extends Remote{
	...
	public boolean createRoom(String name, User owner) throws RemoteException;
	...
	public void sendMessageToRoom(String roomName, String message, User user) throws RemoteException;
}
